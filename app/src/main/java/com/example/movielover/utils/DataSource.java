...
public class DataSource {
    ...
    public static List<Movie> getNewMovies() {
        ...
        listMovies.add(new Movie("Mulan","A young Chinese maiden disguises herself as a male warrior in order to save her father. A live-action feature film based on Disney's 'Mulan.'", R.drawable.mulan, "✰ 7.0",R.drawable.mulancover, "https://www.youtube.com/watch?v=KK8FHdFluOQ", "Action, Adventure, Drama", 2020, "N/A" ));
        ...
        listMovies.add(new Movie("Black Widow","A film about Natasha Romanoff in her quests between the films Civil War and Infinity War.", R.drawable.black_widow, "✰ 7.3",R.drawable.black_widow_cover, "https://www.youtube.com/watch?v=RxAtuMu_ph4", "Action, Adventure, Sci-Fi ", 2020, "N/A" ));
