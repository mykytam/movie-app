...
public class DataSource {
    ...
    public static List<Movie> getNewMovies() {
        ...
        listMovies.add(new Movie("Birds Of Prey","After splitting with the Joker, Harley Quinn joins superheroes Black Canary, Huntress and Renee Montoya to save a young girl from an evil crime lord." ,  R.drawable.harley,"N/A", "N/A", "N/A", R.drawable.harleycover, "https://www.youtube.com/watch?v=x3HbbzHK5Mc", "Action, Adventure, Crime", "2020", "1h 49min" ));
        listMovies.add(new Movie("Mulan","A young Chinese maiden disguises herself as a male warrior in order to save her father. A live-action feature film based on Disney's 'Mulan.'", R.drawable.mulan, "N/A", "N/A", "N/A",R.drawable.mulancover, "https://www.youtube.com/watch?v=KK8FHdFluOQ", "Action, Adventure, Drama", "2020", "N/A" ));
        ...
        listMovies.add(new Movie("No Time To Die", "James Bond has left active service. His peace is short-lived when Felix Leiter, an old friend from the CIA, turns up asking for help, leading Bond onto the trail of a mysterious villain armed with dangerous new technology.", R.drawable.bond, "N/A","N/A", "N/A",R.drawable.bondcover, "https://www.youtube.com/watch?v=BIhNsAtPbPI", "Action, Adventure, Thriller", "2020", "N/A" ));
        listMovies.add(new Movie("Black Widow","A film about Natasha Romanoff in her quests between the films Civil War and Infinity War.", R.drawable.black_widow, "N/A","N/A", "N/A",R.drawable.black_widow_cover, "https://www.youtube.com/watch?v=RxAtuMu_ph4", "Action, Adventure, Sci-Fi", "2020", "N/A" ));
        listMovies.add(new Movie("Marriage Story","Noah Baumbach's incisive and compassionate look at a marriage breaking up and a family staying together.", R.drawable.history, "8.1/10","95/100", "93/100",R.drawable.historycover, "https://www.youtube.com/watch?v=BHi-a1n8t7M", "Comedy, Drama, Romance", "2019", "2h 17min" ));
        return listMovies;
    }
